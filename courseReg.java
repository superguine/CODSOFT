            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    if (coursecapacity[ic.getId(crscode)] <= 0 )
                    {
                        ...
                        cap= coursecapacity[ic.getId(crscode)];
                ...
                case 3:
                    ...
                    break;
                case 4 :
                    String scrs = ic.crsrm();
                    cap= coursecapacity[ic.getId(scrs)];
                    coursecapacity[ic.getId(scrs)] = ++cap;
...
class innercourse {
    ...
    String student[][] = new String[50][4];
    ...
    public String crsrm()
    {
        ...
        String scrs =sc.next();
        student[sid-1][2]= " ---- course removed";
        return scrs;
    }
}
